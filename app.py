"""Create a new file for more comfort."""
...
class PasswordGeneratorApp(tk.Frame):
    ...
    def __init__(self, master=tk.Tk, width:int=600, height:int=370):
        """Initiate the app."""
    ...
    def create_widgets(self):
        ...
        self.generate_button = tk.Button(self.master, text="Generate Password", relief="flat", 
                                     background="grey75", activebackground="grey60", height=3,
                                     highlightthickness=0, borderwidth=0, command=self.generate_password)
        self.generate_button.grid(row=4, column=1, columnspan=2, padx=0, pady=10, sticky="new")
        self.copy_button = tk.Button(self.master, text="Copy Password", relief="flat", 
                                     background="grey75", activebackground="grey60",
                                     highlightthickness=0, borderwidth=0, height=2,
                                     width=15, command=self.copy_password)
        self.copy_button.grid(row=7, column=0, columnspan=2, padx=5, pady=10)
        self.save_button = tk.Button(self.master, text="Save Password", relief="flat", 
                                     background="grey75", activebackground="grey60",
                                     highlightthickness=0, borderwidth=0, height=2,
                                     width=15, command=self.save_password)
